...
gallery_f = np.loadtxt('/home/dff/f/Interpret_FR/test/features_gallery_200id.txt', dtype=np.float32)
query_f = np.loadtxt('/home/dff/f/Interpret_FR/test/features_query_200id.txt', dtype=np.float32)
...
print(dist.shape)
#print(dist)
gallery_id_f = open('/home/dff/f/Interpret_FR/test/labels_gallery_200id.txt')
lines = gallery_id_f.readlines()
gallery_id = []
for line in lines:
    gallery_id.append(int(line.split()[0]))
print(len(gallery_id))
query_id_f = open('/home/dff/f/Interpret_FR/test/labels_query_200id.txt')
